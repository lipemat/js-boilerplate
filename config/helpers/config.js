...
const { dependencies, devDependencies, workingDirectory, packageDirectory } = package_config_1.default.getPackageConfig();
const extensions = [
...
function getBrowsersList() {
    const projectBrowsersList = (0, browserslist_1.default)();
    if ((0, browserslist_1.default)(browserslist_1.default.defaults) === projectBrowsersList) {
...
const getDefaultBrowsersList = () => {
    if ((0, browserslist_1.default)(browserslist_1.default.defaults) === (0, browserslist_1.default)()) {
        const wp = [...require('@wordpress/browserslist-config')];
        return adjustBrowserslist(wp);
    }
    return false;
